...
DEFAULT_QUERIES = {
    "rice_package": [
        "arroz pacote 1kg supermercado foto real -mockup -maquete -psd -template -vector -freepik -shutterstock -depositphotos -vecteezy -alamy",
        "arroz pacote 2kg supermercado foto real -mockup -maquete -psd -template -vector -freepik -shutterstock -depositphotos -vecteezy -alamy",
        "arroz pacote 5kg supermercado foto real -mockup -maquete -psd -template -vector -freepik -shutterstock -depositphotos -vecteezy -alamy",
        "pacote de arroz prateleira supermercado marcas brasileiras -mockup -maquete -psd -template -vector -freepik -shutterstock",
        "arroz camil 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz camil 5kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz tio joao 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz tio joao 5kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz prato fino 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz kicaldo 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz urbano 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz namorado 1kg pacote foto produto mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz branco tipo 1 pacote 1kg foto real mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz branco tipo 1 pacote 5kg foto real mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz integral pacote 1kg foto real mercado -mockup -maquete -psd -template -vector -freepik",
        "arroz parboilizado pacote 1kg foto real mercado -mockup -maquete -psd -template -vector -freepik",
        "multiple rice bags supermarket shelf photo -mockup -template -vector -illustration -freepik -shutterstock",
    ],
    "beans_package": [
